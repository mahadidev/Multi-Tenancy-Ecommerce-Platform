...
const productInitialValues = {
    ...
    slug: "google-pixel-8",
    sku: "google-pixel-8-smart-phone",
    short_description: "demo",
    description:
        "The new Google Pixel 8 with exceptional camera and performance.",
    price: 50000,
    category_id: 11,
    brand_id: 3,
    has_in_stocks: 1,
    ...
    is_trending: 0,
    has_discount: 1,
    discount_to: "2025-01-31 14:13:06",
        ...
        setFormState((prev: any) => {
            ...
            if (
                ...
                updatedVariants[variantIndex].options = updatedVariants[
                    variantIndex
                ].options.filter((_: any, idx: number) => idx !== optionIndex);
            }
