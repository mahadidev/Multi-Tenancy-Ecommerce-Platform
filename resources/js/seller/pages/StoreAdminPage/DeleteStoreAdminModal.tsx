...
const DeleteStoreAdminModal: FC<PropsType> = function (props) {
    const [isOpen, setOpen] = useState(false);
    const { deleteAdmin } = useStoreAdmin();
    return (
        <>
            <Button
                size="sm"
                    ...
                    <div className="flex flex-col items-center gap-y-6 text-center">
                        ...
                        <div className="flex items-center gap-x-3">
                            <Button
                                ...
                                isProcessing={deleteAdmin.isLoading}
...
export default DeleteStoreAdminModal;
