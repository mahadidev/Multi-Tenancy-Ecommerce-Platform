		...
		<>
			...
			<Modal show={isModalOpen} onClose={() => setModalOpen(false)} size="7xl">
				<Modal.Header className="pb-0 border-b-0">
					<Button.Group>
						<Button
							...
							className={`${
								activeTab === 'upload' && '!bg-gray-100 dark:!bg-gray-700'
						...
						<Button
							...
							className={`${
								activeTab === 'gallery' && '!bg-gray-100 dark:!bg-gray-700'
							} rounded-b-none border-b-0  shadow-clear`}
							style={{
								boxShadow: '0 0 !important',
							}}
				...
				<Modal.Body className="px-5 py-0">
					<div className="bg-gray-100 dark:bg-gray-700 rounded-lg rounded-tl-none min-h-[69dvh] overflow-hidden">
						{activeTab === 'gallery' ? (
							<>
								{files && (
									<GalleryCard
