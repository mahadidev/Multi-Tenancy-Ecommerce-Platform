                    ...
                    <div className="flex justify-between items-center">
                        <div className="flex justify-start items-center">
                            ...
                            <a href="./" className="flex mr-14">
                                <img
                                    src={`${BASE_URL}/images/seller/logo.svg`}
                                    className="mr-3 h-8"
                                    alt="FlowBite Logo"
                                />
                        ...
                        <div className="flex items-center">
                                ...
                                <div>
                                    ...
                                    >
                                        <div className="flex-shrink-0">
                                            <img
                                                ...
                                                src={`${BASE_URL}/images/seller/bonnie-green.png`}
                                                alt="Jese image"
                                            />
                                    ...
                                    >
                                        <div className="flex-shrink-0">
                                            <img
                                                className="w-11 h-11 rounded-full"
                                                src={`${BASE_URL}/images/seller/jese-leos.png`}
                                                alt="Jese image"
                                            />
                                    ...
                                    >
                                        <div className="flex-shrink-0">
                                            <img
                                                className="w-11 h-11 rounded-full"
                                                src={`${BASE_URL}/images/seller/joseph-mcfall.png`}
                                                alt="Joseph image"
                                            />
                                    ...
                                    >
                                        <div className="flex-shrink-0">
                                            <img
                                                className="w-11 h-11 rounded-full"
                                                src={`${BASE_URL}/images/seller/leslie-livingston.png`}
                                                alt="Leslie image"
                                            />
                                    ...
                                    >
                                        <div className="flex-shrink-0">
                                            <img
                                                className="w-11 h-11 rounded-full"
                                                src={`${BASE_URL}/images/seller/robert-brown.png`}
                                                alt="Robert image"
                                            />
                            ...
                            <div
                                className="hidden overflow-hidden z-20 z-50 my-4 max-w-sm text-base list-none bg-white rounded divide-y divide-gray-100 shadow-lg dark:bg-gray-700 dark:divide-gray-600"
                                id="apps-dropdown"
                            >
                                <div className="block py-2 px-4 text-base font-medium text-center text-gray-700 bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                                    Apps
                                ...
                                <div className="grid grid-cols-3 gap-4 p-4">
                                    ...
                                    >
                                        <svg
                                            className="mx-auto mb-1 w-7 h-7 text-gray-500 dark:text-gray-400"
                                            fill="currentColor"
                                            viewBox="0 0 20 20"
                                            xmlns="http://www.w3.org/2000/svg"
                                        >
                                ...
                                <div>
                                    ...
                                    >
                                        ...
                                        <img
                                            ...
                                            src={`${BASE_URL}/images/seller/users/neil-sims.png`}
                                            alt="user photo"
                                        />
                                    </button>
                                </div>
