                ...
                <table cellpadding="0" cellspacing="0" border="0" width="800" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 0 auto;">
                    ...
                    <tr>
                        <td style="padding: 40px 20px; background-color: #f8f9fa; border-top-left-radius: 8px; border-top-right-radius: 8px; text-align: center;">
                            ...
                            @endif
                            <h1 style="color: #4CAF50; font-size: 36px; margin: 0; font-weight: bold;">Welcome to {{ $store->name }}!</h1>
                            <h2 style="color: #333333; margin: 20px 0;">You have been assigned as a <strong>{{ $role->name }}</strong></h2>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding: 40px;">
                            <p style="color: #666666; font-size: 16px; line-height: 1.6;">
                                ...
                                Welcome to <strong>{{ $store->name }}</strong>! You have been successfully added as a <strong>{{ $role->name }}</strong>. You can now access your store and manage your tasks efficiently.
                            </p>
                            
                            <!-- User Credentials Section -->
                            <table cellpadding="0" cellspacing="0" border="0" width="100%" style="margin-top: 20px; background-color: #f8f9fa; padding: 20px; border-radius: 8px;">
                                <tr>
                    ...
                    <tr>
                        <td style="padding: 30px; background-color: #f8f9fa; text-align: center;">
                            <p style="color: #666666; margin: 0;">© {{ date('Y') }} Chologori. All rights reserved.</p>
                        </td>
                    </tr>
                </table>
            </td>
