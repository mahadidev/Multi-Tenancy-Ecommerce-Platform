                ...
                <table cellpadding="0" cellspacing="0" border="0" width="800" style="background-color: #ffffff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 0 auto;">
                    ...
                    <tr>
                        <td style="padding: 40px;">
                            <p style="color: #666666; font-size: 16px; line-height: 1.6;">
                                ...
                                Welcome to <strong>{{ $store->name }}</strong>! We’re excited to have you on board. You can now explore our store, browse products, and enjoy a seamless shopping experience. <br><br>
                    ...
                    <tr>
                        <td style="padding: 30px; background-color: #f8f9fa; text-align: center;">
                            <p style="color: #666666; margin: 0;">© {{ date('Y') }} {{ $store->name }}. All rights reserved.</p>
                        </td>
                    </tr>
                </table>
            </td>
