...
import {
    setIsOpenMobile,
    setSidebarCollapsed,
} from '@seller-panel/store/slices/uiSlice';
import { useAppDispatch, useAppSelector } from '@seller-panel/store/store';
...
const pages: SidebarItem[] = [
	{ href: Path.DashboardPage.index(), icon: HiChartPie, label: 'Dashboard' },
	{
		icon: HiShoppingBag,
		label: 'E-commerce',
		items: [
			{ href: Path.CategoriesPage.index(), label: 'Category' },
			{ href: Path.BrandsPage.index(), label: 'Brand' },
			{ href: Path.ProductsPage.index(), label: 'Products' },
		],
	},
];
...
const externalPages: SidebarItem[] = [
	{
		href: Path.StorePagesPage.index(),
